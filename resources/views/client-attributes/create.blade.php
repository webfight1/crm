        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('client-attributes.store') }}">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="flex items-center mt-1">
                                    <input id="color" type="color" name="color" value="{{ old('color', '#3B82F6') }}" class="h-10 w-20 border-gray-300 rounded-md shadow-sm" required />
                                    <x-text-input id="color_text" class="block ml-2 w-full" type="text" value="{{ old('color', '#3B82F6') }}" readonly />
                                </div>
